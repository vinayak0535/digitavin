...
const PortfolioSection = () => {
  ...
  const projects = [
    {
      ...
      challenge: "Outdated website failing to showcase properties effectively, resulting in low lead generation and poor user engagement.",
      solution: "Built a modern, mobile-responsive real estate portal with advanced property search, interactive virtual tours, lead capture system.",
      result: "47% increase in qualified property leads within the first quarter and reduced admin workload by 40%.",
      stats: "+47%",
    ...
    },
    {
      ...
      title: "FitZone Gym",
      challenge: "Lacked online visibility and struggled to attract new members through digital channels.",
      solution: "Built a modern, mobile-responsive website with membership management, class schedules, and online booking system.",
      result: "65% increase in member signups within the first quarter and reduced admin workload by 40%.",
      stats: "+65%",
    ...
    },
    {
      ...
      challenge: "Manual appointment booking led to double bookings, missed opportunities, and frustrated customers.",
      solution: "Built an elegant website with integrated online booking system, service gallery, automated SMS reminders, loyalty program, and social media integration.",
      result: "40% increase in bookings and 100% elimination of double bookings, plus 35% increase in repeat customers.",
      stats: "+40%",
  ...
  // Prepare content for StickyScroll component
...
📊 Impact: ${project.metric} ${project.stats}`,
  ...
  >
    <img
      ...
      alt={project.title}
      className="w-full h:full align-middle object-cover  transition-transform duration-700 group-hover:scale-105"
    />
